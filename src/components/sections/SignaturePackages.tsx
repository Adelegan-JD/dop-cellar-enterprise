            ...
            return (
              ...
              >
                ...
                <a
                  ...
                  className="mt-auto inline-flex items-center justify-between gap-2 rounded-md border border-hairline bg-background/60 px-4 py-2.5 pt-3 text-[13px] font-medium text-foreground transition-colors hover:border-gold/40 hover:bg-gold/10"
                  style={{ marginTop: "auto", marginBlockStart: "1.75rem" }}
                >
                  {p.ctaLabel}
