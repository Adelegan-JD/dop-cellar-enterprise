...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dop Cellar Merit" },
      { property: "og:title", content: "Dop Cellar Merit" },
      { name: "twitter:title", content: "Dop Cellar Merit" },
      { name: "description", content: "Building Reliable Infrastructure" },
      { property: "og:description", content: "Building Reliable Infrastructure" },
      { name: "twitter:description", content: "Building Reliable Infrastructure" },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/ViWGlO78KHfM5zIUR6wLybuQIw03/social-images/social-1779261959696-cellar_2.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/ViWGlO78KHfM5zIUR6wLybuQIw03/social-images/social-1779261959696-cellar_2.webp" },
    ],
    links: [
